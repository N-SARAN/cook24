...
import 'package:streesathi/model/user.dart';
      ...
      try {
        ...
        UserCredential userCredential = await FirebaseAuth.instance
            .createUserWithEmailAndPassword(
                email: _formData['gaurdian_email'].toString(),
        ...
        if (userCredential.user != null) {
          ...
          final user = UserModel(
            ...
            husbandEmail: _formData['gaurdian_email'].toString(),
            id: v,
            role: 'gaurdian',
          );
